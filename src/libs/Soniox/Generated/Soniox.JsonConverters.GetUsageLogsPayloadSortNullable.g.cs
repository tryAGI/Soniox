...
{
    /// <inheritdoc />
    public sealed class GetUsageLogsPayloadSortNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Soniox.GetUsageLogsPayloadSort?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Soniox.GetUsageLogsPayloadSortExtensions.ToValueString(value.Value));
            }
        }
    }
}
