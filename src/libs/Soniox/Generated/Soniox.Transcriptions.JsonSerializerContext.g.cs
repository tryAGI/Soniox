...
namespace Soniox
{
    ...
    internal sealed partial class TranscriptionsSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class TranscriptionsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static TranscriptionsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private TranscriptionsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::Soniox.TranscriptionStatus)

                    || typeToConvert == typeof(global::Soniox.TranscriptionStatus?)

                    || typeToConvert == typeof(global::Soniox.TranslationConfigType)
            ...
            {
                if (typeToConvert == typeof(global::Soniox.TranscriptionStatus))
                {
                    return new global::Soniox.JsonConverters.TranscriptionStatusJsonConverter();
                }

                if (typeToConvert == typeof(global::Soniox.TranscriptionStatus?))
                {
                    return new global::Soniox.JsonConverters.TranscriptionStatusNullableJsonConverter();
                }

                if (typeToConvert == typeof(global::Soniox.TranslationConfigType))
                {
                    return new global::Soniox.JsonConverters.TranslationConfigTypeJsonConverter();
                }

                if (typeToConvert == typeof(global::Soniox.TranslationConfigType?))
                {
                    return new global::Soniox.JsonConverters.TranslationConfigTypeNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new TranscriptionsSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
