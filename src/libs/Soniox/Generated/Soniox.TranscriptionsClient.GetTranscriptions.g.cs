...
namespace Soniox
{
    public partial class TranscriptionsClient
    {
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement s_GetTranscriptionsSecurityRequirement0 =
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement[] s_GetTranscriptionsSecurityRequirements =
            new global::Soniox.EndPointSecurityRequirement[]
            {                s_GetTranscriptionsSecurityRequirement0,
            };
        partial void PrepareGetTranscriptionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? cursor);
        partial void PrepareGetTranscriptionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string? cursor);
        partial void ProcessGetTranscriptionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTranscriptionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Soniox.GetTranscriptionsResponse> GetTranscriptionsAsync(
            int? limit = default,
            string? cursor = default,
            global::Soniox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTranscriptionsAsResponseAsync(
                limit: limit,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Soniox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Soniox.AutoSDKHttpResponse<global::Soniox.GetTranscriptionsResponse>> GetTranscriptionsAsResponseAsync(
            int? limit = default,
            string? cursor = default,
            global::Soniox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTranscriptionsArguments(
            ...
            var __authorizations = global::Soniox.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTranscriptionsSecurityRequirements,
                operationName: "GetTranscriptionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTranscriptionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Soniox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTranscriptionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTranscriptionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid request.  Error types: - `invalid_cursor`: Invalid cursor parameter. 
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTranscriptionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Soniox.GetTranscriptionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Soniox.AutoSDKHttpResponse<global::Soniox.GetTranscriptionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Soniox.GetTranscriptionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
