...
namespace Soniox
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement s_UploadFileSecurityRequirement0 =
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement[] s_UploadFileSecurityRequirements =
            new global::Soniox.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Soniox.File> UploadFileAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Soniox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Soniox.AutoSDKHttpResponse<global::Soniox.File>> UploadFileAsResponseAsync(
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.ClientReferenceId != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.ClientReferenceId ?? string.Empty),
            ...
            try
            {
                ...
                else
                {
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid request.  Error types: - `invalid_request`:   - Invalid request.   - Exceeded maximum file size (maximum is 1073741824 bytes). 
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Soniox.File.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Soniox.AutoSDKHttpResponse<global::Soniox.File>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Soniox.File.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Soniox.File> UploadFileAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Soniox.UploadFileRequest
            {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Soniox.UploadFileRequest
            {
                ClientReferenceId = clientReferenceId,
                    ...
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Soniox.File.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Soniox.File.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
