...
namespace Soniox.Realtime.Tts
{
    public sealed partial class SonioxTtsRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Soniox.Realtime.Tts.ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Soniox.Realtime.Tts.ServerEvent @event;
                    try
                    {
                        @event = (global::Soniox.Realtime.Tts.ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Soniox.Realtime.Tts.ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.Tts.ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.TtsAudio is { } __TtsAudioReceived)
            {
                TtsAudioReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.Tts.TtsAudio>(
                        __TtsAudioReceived,
                        rawText,
                        json));
            }
            if (@event.TtsTerminated is { } __TtsTerminatedReceived)
            {
                TtsTerminatedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.Tts.TtsTerminated>(
                        __TtsTerminatedReceived,
                        rawText,
                        json));
            }
            if (@event.TtsError is { } __TtsErrorReceived)
            {
                TtsErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.Tts.TtsError>(
                        __TtsErrorReceived,
                        rawText,
                        json));
            }
