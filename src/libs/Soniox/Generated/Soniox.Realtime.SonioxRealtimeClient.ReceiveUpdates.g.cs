...
namespace Soniox.Realtime
{
    public sealed partial class SonioxRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Soniox.Realtime.ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Soniox.Realtime.ServerEvent @event;
                    try
                    {
                        @event = (global::Soniox.Realtime.ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Soniox.Realtime.ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.RealtimeResult is { } __RealtimeResultReceived)
            {
                RealtimeResultReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.RealtimeResult>(
                        __RealtimeResultReceived,
                        rawText,
                        json));
            }
            if (@event.RealtimeError is { } __RealtimeErrorReceived)
            {
                RealtimeErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Soniox.Realtime.RealtimeError>(
                        __RealtimeErrorReceived,
                        rawText,
                        json));
            }
        }
