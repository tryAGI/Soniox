...
namespace Soniox
{
    public partial class TranscriptionsClient
    {
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement s_GetTranscriptionsCountSecurityRequirement0 =
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement[] s_GetTranscriptionsCountSecurityRequirements =
            new global::Soniox.EndPointSecurityRequirement[]
            {                s_GetTranscriptionsCountSecurityRequirement0,
            };
        partial void PrepareGetTranscriptionsCountArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetTranscriptionsCountRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetTranscriptionsCountResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTranscriptionsCountResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Soniox.GetTranscriptionsCountResponse> GetTranscriptionsCountAsync(
            global::Soniox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTranscriptionsCountAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Soniox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Soniox.AutoSDKHttpResponse<global::Soniox.GetTranscriptionsCountResponse>> GetTranscriptionsCountAsResponseAsync(
            global::Soniox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTranscriptionsCountArguments(
                httpClient: HttpClient);


            var __authorizations = global::Soniox.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetTranscriptionsCountSecurityRequirements,
                operationName: "GetTranscriptionsCountAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTranscriptionsCountRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Soniox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTranscriptionsCount",
                                methodName: "GetTranscriptionsCountAsync",
                                pathTemplate: "\"/v1/transcriptions/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTranscriptionsCountResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTranscriptionsCountResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Soniox.GetTranscriptionsCountResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Soniox.AutoSDKHttpResponse<global::Soniox.GetTranscriptionsCountResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Soniox.GetTranscriptionsCountResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
