...
namespace Soniox
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Soniox.AutoSDKRetryOptions Retry { get; set; } = new global::Soniox.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Soniox.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Soniox.IAutoSDKHook>();
        ...
        public global::Soniox.AutoSDKClientOptions AddHook(
            global::Soniox.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Soniox.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Soniox.AutoSDKClientOptions UseAuthorizationProvider(
            global::Soniox.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Soniox.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Soniox.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Soniox.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Soniox.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Soniox.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Soniox.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Soniox.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Soniox.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Soniox.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Soniox.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Soniox.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Soniox.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Soniox.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Soniox.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Soniox.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Soniox.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Soniox.AutoSDKClientOptions clientOptions,
            global::Soniox.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Soniox.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Soniox.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Soniox.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Soniox.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Soniox.IAutoSDKHook, global::Soniox.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Soniox.AutoSDKHookContext context)
        {
