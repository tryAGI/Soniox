...
namespace Soniox
{
    public partial class TranscriptionsClient
    {
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement s_GetTranscriptionSecurityRequirement0 =
        ...
        private static readonly global::Soniox.EndPointSecurityRequirement[] s_GetTranscriptionSecurityRequirements =
            new global::Soniox.EndPointSecurityRequirement[]
            {                s_GetTranscriptionSecurityRequirement0,
            };
        partial void PrepareGetTranscriptionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid transcriptionId);
        partial void PrepareGetTranscriptionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid transcriptionId);
        partial void ProcessGetTranscriptionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTranscriptionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Soniox.Transcription> GetTranscriptionAsync(
            global::System.Guid transcriptionId,
            global::Soniox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTranscriptionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Soniox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Soniox.AutoSDKHttpResponse<global::Soniox.Transcription>> GetTranscriptionAsResponseAsync(
            global::System.Guid transcriptionId,
            global::Soniox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTranscriptionArguments(
            ...
            var __authorizations = global::Soniox.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTranscriptionSecurityRequirements,
                operationName: "GetTranscriptionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTranscriptionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Soniox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTranscriptionAsync",
                                pathTemplate: "$\"/v1/transcriptions/{transcriptionId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTranscriptionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Soniox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTranscriptionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Soniox.Transcription.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Soniox.AutoSDKHttpResponse<global::Soniox.Transcription>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Soniox.Transcription.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
